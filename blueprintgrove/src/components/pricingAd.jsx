...
export default function PricingAd() {
  return (
    <section className=" py-28 bg-whiiteish">
      <div className="w-4/6 mx-auto">
        <div className="grid grid-cols-2 mb-10">
          ...
          <p className=" text-xs text-greyish w-fit h-fit text-justify my-auto">
        ...
        <div className="grid grid-cols-3 gap-5 mb-10">
          <div className="bg-[#ffffff] p-8 shadow-lg">
            ...
            <div className=" text-greyish text-xs ">
              <p className="mt-4">
        ...
        <div className="grid grid-cols-2 gap-10">
          <div>
            ...
            <p className=" text-justify pl-6 text-greyish text-sm mt-1">
              lacinia, tempor lacus at, eleifend diam. Maecenas tempus tincidunt
              placeratneque, maximus mattis
            </p>
          </div>
          <div>
            <p className=" text-darkblue font-bold text-base">
